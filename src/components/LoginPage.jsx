  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden p-4">
      ...
      <motion.div
        ...
        className="w-full max-w-md p-4 sm:p-8 bg-black/40 backdrop-blur-xl rounded-2xl border border-green-500/20 shadow-2xl shadow-green-500/10"
      >
        <motion.div
          initial={{ scale: 0.8 }}
          animate={{ scale: 1 }}
        ...
        >
          ...
          <motion.div 
            ...
            className="mt-4 p-4 bg-green-500/10 rounded-xl border border-green-500/20 space-y-2"
          >
            <div className="flex items-center justify-between text-xs text-green-300">
              ...
              <div className="flex items-center gap-1">
                <Server size={14} />
                <span>System Status: <span className="text-green-500 font-semibold">SECURE</span></span>
              </div>
            </div>
            <div className="flex items-center gap-1 text-xs text-green-300">
              <Fingerprint size={14} />
              <span>Step {step}/2: {step === 1 ? 'Decode and enter credentials' : 'Find the flag in somewhere where google spiders are afraid to tread'}</span>
            </div>
          </motion.div>
            ...
            >
              ...
              <div className="p-6 bg-green-500/5 rounded-xl border border-green-500/20">
                ...
                <div className="space-y-2 text-gray-400 text-sm">
                  <p>• Even robots need to know where to look</p>
                </div>
              </div>
            </motion.div>
          )}
